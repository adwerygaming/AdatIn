...
object GlobalVariable {
    var activeAccount: Customer? = Customer("masdepan@adatin.com", "admin#1234", "MasDepan", "Jl. Amikom", "123", R.drawable.team_pic_devan)
    val accounts: MutableList<Customer> = mutableListOf(
        Customer("masdepan@adatin.com", "admin#1234", "MasDepan", "Jl. Amikom", "123", R.drawable.team_pic_devan),
